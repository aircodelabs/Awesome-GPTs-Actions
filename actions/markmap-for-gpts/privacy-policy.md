...
-   **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to GetOffer, Haidian, Beijing.
...
-   **Website** refers to GetOffer, accessible from [https://getoffer.ai](https://getoffer.ai/)
